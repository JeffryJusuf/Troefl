        ...
        <div class="row py-lg-5">
            @auth
                <div class="col-lg-7 col-md-8 mx-auto">
                    <h1 class="mt-3 mb-5">Welcome to <img src="/img/troefl-text-dark.png" alt="" width="170"> , {{ auth()->user()->username }}</h1>
                    ...
                    <p class="mt-5">
                        ...
                        <a href="/discussions" class="btn btn-lg btn-dark">
                            <small class="fs-6">
            ...
            @else
                <div class="col-lg-7 col-md-8 mx-auto">
                    <h1 class="mt-0 mb-5">Welcome to <img src="/img/troefl-text-dark.png" alt="" width="170"></h1>
                    <p class="lead pt-5 border-top border-dark-subtle">
                        Test & Improve your English Skill by Trying our Online English Test with TOEFL Standard.
                    </p>
                    <p class="lead py-3">
                        Looks like you aren't signed in yet. <a href="/login" class="text-decoration-none">Sign in now.</a>
                    </p>
                    <p class="lead pb-5 border-bottom border-dark-subtle">
