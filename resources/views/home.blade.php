    ...
    <section class="py-4 text-center container">
        <div class="row py-lg-5">
            ...
            <div class="col-lg-7 col-md-8 mx-auto">
                    ...
                    <p class="lead py-5 border-top border-bottom">Test & Improve your English Skill by Trying our Online English Test with TOEFL Standard</p>
                    <p class="mt-5">
                        ...
                        <a href="/discussion" class="btn btn-lg btn-secondary">
                            <small class="fs-6">
